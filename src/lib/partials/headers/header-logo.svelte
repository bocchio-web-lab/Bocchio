<a href="/" class="group flex items-center gap-4">
	<svg viewBox="0 0 205 200" xmlns="http://www.w3.org/2000/svg" class="h-9 sm:h-14">
		<g id="Bulbo">
			<path
		...
		<g id="Ingranaggi">
			...
			<g id="Piccolo">
				...
				/>
				<path
					d="M105,113.44a14.33,14.33,0,0,1-1.6,4.72L98.9,115.8a14.42,14.42,0,0,1,3-4l3.14,1.64Z"
					transform="translate(-13.85 -17.21)"
					class="fill-primary"
				/>
				<path
					d="M110.25,123.2a14.58,14.58,0,0,1-4.69,1.68l-1-5a14.53,14.53,0,0,1,5-.18l.68,3.49Z"
					transform="translate(-13.85 -17.21)"
					class="fill-primary"
				/>
				<path
					d="M105.87,133.37a14.63,14.63,0,0,1-4.24-2.62l3.31-3.87a14.61,14.61,0,0,1,3.24,3.79l-2.31,2.7Z"
					transform="translate(-13.85 -17.21)"
					class="fill-primary"
				/>
				<path
					d="M95.19,136.27a14.38,14.38,0,0,1-.59-4.94l5.08.18a14.26,14.26,0,0,1-1,4.89l-3.54-.13Z"
					transform="translate(-13.85 -17.21)"
					class="fill-primary"
				/>
				<path
					d="M86.26,129.72a14.4,14.4,0,0,1,3.51-3.54l3,4.09a14.57,14.57,0,0,1-4.42,2.31l-2.11-2.86Z"
					transform="translate(-13.85 -17.21)"
					class="fill-primary"
				/>
				<path
					d="M85.83,118.66a14.24,14.24,0,0,1,5,.54l-1.33,4.91a14.28,14.28,0,0,1-4.55-2l.92-3.42Z"
					transform="translate(-13.85 -17.21)"
					class="fill-primary"
				/>
				<path
					d="M94.23,111.43a14.74,14.74,0,0,1,2.66,4.22l-4.67,2A14.42,14.42,0,0,1,91,112.85l3.26-1.42Z"
					transform="translate(-13.85 -17.21)"
					class="fill-primary"
				/>
			</g>
		...
		<g id="Raggi">
			<path
				d="M61.53,152.88,37.91,173.39c-4.31,3.47-9.28-3-4.83-6.26L59,149.53a2.12,2.12,0,0,1,2.58,3.35Z"
				transform="translate(-13.85 -17.21)"
				class="fill-primary"
			/>
			<path
				d="M47.79,96,17.05,90.2C11.66,89,13.62,81.09,19,82.54L48.82,91.9a2.12,2.12,0,0,1-1,4.11Z"
				transform="translate(-13.85 -17.21)"
				class="fill-primary"
			/>
			<path
				d="M82.78,50.51l-15-27.45a4,4,0,1,1,7.14-3.38l11.71,29a2.12,2.12,0,0,1-3.82,1.81Z"
				transform="translate(-13.85 -17.21)"
				class="fill-primary"
			/>
			<path
				d="M167.86,149.53l25.87,17.6c4.45,3.29-.5,9.73-4.82,6.26l-23.63-20.51a2.12,2.12,0,0,1,2.58-3.35Z"
				transform="translate(-13.85 -17.21)"
				class="fill-primary"
			/>
			<path
				d="M178,91.9l29.86-9.36c5.33-1.46,7.32,6.42,1.92,7.66L179,96a2.12,2.12,0,0,1-1-4.11Z"
				transform="translate(-13.85 -17.21)"
				class="fill-primary"
			/>
			<path
				d="M140.22,48.7l11.71-29c2.26-5,9.61-1.58,7.14,3.38L144,50.51a2.12,2.12,0,0,1-3.82-1.81Z"
				transform="translate(-13.85 -17.21)"
				class="fill-primary"
			/>
		</g>
	...
	<!-- <h3 class="text-center text-lg font-bold sm:text-xl">Tommaso Bocchietti</h3> -->
</a>
